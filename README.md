...
You can also **add new words** for players and find out who the **winner** is!
...
- Calculates total points for each player.  
- Add new words for players dynamically.  
- Automatically finds the winner.  
- Displays a summary of players and their words.
